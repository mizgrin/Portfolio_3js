...
const Hero = () => {
  const downloadCV = () => {
    window.open('https://drive.google.com/file/d/1xZVvWzy0dTppBRbdoN5240pYwmCKvjCn/view?usp=sharing', '_blank');
  }
  return (
    <section className='relative w-full h-screen mx-auto'>
        <div className={` ${styles.paddingX} absolute inset-0 top-[120px] max-w-8xl mx-auto flex flex-row items-start gap-5 mb-12 z-10`}>
          ...
          <div>
            ...
            <p className={`${ styles.heroSubText} text-white mb-3 `}> As a website developer and designer, I specialize in creating engaging websites.</p>
            <button
              onClick={downloadCV}
